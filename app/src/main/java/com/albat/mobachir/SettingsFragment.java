...
import com.albat.mobachir.billing.BillingProcessor;
import com.albat.mobachir.billing.TransactionDetails;
        ...
        preferencerate
                .setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        Uri uri = Uri.parse("https://sites.google.com/view/gamesdevlopprivacy/classico-games-privacy-policy"
                        );
